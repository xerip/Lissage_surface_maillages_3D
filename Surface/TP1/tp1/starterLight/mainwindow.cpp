...
{
    Courbures courb(mesh) ;
    MyMesh::VertexHandle vh = mesh.vertex_handle(55);
    std::vector<MyMesh::VertexHandle> neig = courb.get_two_neighborhood(vh);
    courb.draw_quad(vh,&mesh);
...
{
    Courbures courb(mesh) ;
    MyMesh::VertexHandle vh = mesh.vertex_handle(position);
    std::vector<MyMesh::VertexHandle> neig = courb.get_two_neighborhood(vh);
    courb.draw_quad(vh,&mesh);
