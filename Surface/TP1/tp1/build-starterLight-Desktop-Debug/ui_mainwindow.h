...
public:
    ...
    QPushButton *pushButton_courbures;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_courbures = new QPushButton(widget_2);
        pushButton_courbures->setObjectName(QStringLiteral("pushButton_courbures"));

        verticalLayout->addWidget(pushButton_courbures);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_courbures->setText(QApplication::translate("MainWindow", "Courbures", Q_NULLPTR));
        pushButton->setText(QApplication::translate("MainWindow", "Afficher quadrique", Q_NULLPTR));
    } // retranslateUi
